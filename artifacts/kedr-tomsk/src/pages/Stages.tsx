...
export default function Stages() {
  ...
  return (
    <div className="min-h-screen bg-background fade-in-section visible pt-20" data-testid="stages-page">
      {/* Hero */}
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full bg-white rounded-xl p-2 border border-border shadow-sm">
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent className="px-4 text-muted-foreground text-base">
                Все сроки в договоре указываются с небольшим запасом на неблагоприятные погодные условия. При значительных задержках мы информируем клиента заранее, но за 25 лет работы мы ни разу не нарушили договорные сроки сдачи.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
